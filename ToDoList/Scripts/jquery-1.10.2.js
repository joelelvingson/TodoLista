...
jQuery.event = {
	...
	remove: function( elem, types, handler, selector, mappedTypes ) {
		var j, handleObj, tmp,
			...
			namespaces, origType,
			elelgata = jQuery.hasData( elem ) && jQuery._data( elem );
		...
		while ( t-- ) {
			...
			if ( origCount && !handlers.length ) {
				if ( !special.teardown || special.teardown.call( elem, namespaces, elelgata.handle ) === false ) {
